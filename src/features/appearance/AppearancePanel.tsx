...
const accentChoices = (Object.keys(accentPresets) as AccentPreference[]).map(
  (value) => ({
    value,
  ...
  const themeChoices: readonly Choice<ThemePreference>[] = [
    {
      value: "system",
      label: "System",
      decoration: <DesktopIcon weight={iconWeight} aria-hidden="true" />,
    },
    {
      value: "light",
      label: "Light",
      decoration: <SunIcon weight={iconWeight} aria-hidden="true" />,
    },
    {
      value: "dark",
      label: "Dark",
      decoration: <MoonIcon weight={iconWeight} aria-hidden="true" />,
    },
  ];
    ...
    <>
      ...
      >
        ...
        <footer className="appearance-footer">
          ...
          >
            <ArrowCounterClockwiseIcon weight={iconWeight} aria-hidden="true" />
